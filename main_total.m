clear all; clc; addpath(genpath('C:\Users\Fathima\Desktop\thesis folder\fingerprint\simple\FVC2002\DB1_B'));
...
TestDb = uigetdir('C:\Users\Fathima\Desktop\thesis folder\fingerprint\simple\FVC2002\DB1_B', 'Select test database path');
